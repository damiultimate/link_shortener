...
<head>       
	...
	<meta property="og:title" content="Change your password - Infinity - Premium URL Shortener Theme" />
    ...
    <title>Change your password - Infinity - Premium URL Shortener Theme</title> 
...
<section class="under-head-cont">
	<div class="container">
		<div class="centered form">      
			...
			<form role="form" class="live_form" id="login_form" method="post" action="passwords.php">
				...
				<div class="form-group">
					<input type="password" class="form-control" id="pass2" placeholder="Repeat Password" name="cpassword" required="" />
					<i class="zmdi zmdi-dialpad"></i>
				</div>  
				<input type='hidden' name='token' value='f33777c1d3f632422c99824d61e03a253eb0c7ac' />
				<button type="submit" class="mdbtn btn btn-primary width100">Change password</button>
				<hr />
			</form>        
		</div>
	</div>
